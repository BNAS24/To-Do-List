        ...
        <div className='newTask' onClick={createTask}>
            <svg xmlns="http://www.w3.org/2000/svg" width="510" height="40" viewBox="0 0 510 40" fill="none">
                ...
                <g filter="url(#filter0_d_8_33)">
                    ...
                    <rect x="236.5" y="1.5" width="29" height="29" stroke="#F9756A" stroke-width="3" />
                </g>
                <line x1="251" y1="6.20001" x2="251" y2="25.4" stroke="black" stroke-width="4" />
                <line x1="241" y1="15.6667" x2="260.6" y2="15.6667" stroke="black" stroke-width="4" stroke-linejoin="bevel" />
                <defs>
                    <filter id="filter0_d_8_33" x="231" y="0" width="40" height="40" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
